...
<!--          <el-popconfirm class="ele-action" title="确定要删除此视频吗？" @confirm="remove(row)"
                         v-if="permission.includes('sys:video:delete') && row.status==4">
...
export default {
  ...
  data() {
    return {
      ...
      showType: '67',
      // 表格搜索条件
      where: {'video_type':2, 'show_type':67},
      dialogVisible: false,
